  ...
  posts = [
...

    {
      ...
      dailyPosts: [
        ...
        },
        {
          ...
          description: 'Emma Twersky is on the Angular team at Google. In this Jamsnack from Jamstack Conf 2021, she gives us a small peek into the world of all that\'s happened in Angular in the past year, from debugging tools to improved developer experience and more. ',
    ...
    },
    {
      ...
      dailyPosts: [
        {
          id: 'DATELETTER',
          slug: '2021-10-DATELETTER',
          type: 'blog',
          duration: '',
          title: 'TITLE',
          url: 'URL',
          description: 'DESCRIPTION',
          imgUrl: '2021-10-DATELETTER.png',
