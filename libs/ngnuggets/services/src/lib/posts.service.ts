  ...
  posts: PostDetail[] = [
    ...
    },
    {
      ...
      contentUrl:
        'https://webrush.io/episodes/episode-152-creating-a-successful-front-end-onboarding-plan-with-dana-yudelevich',
      contentDescription:
        'Breaking Changes - router. The router will no longer replace the browser URL when a new navigation cancels an ongoing navigation. This often causes URL flicker and was only in place to support some AngularJS hybrid applications ...',
      imgUrl: '2021-09-23-b.png',
      datePosted: '2021-09-23',
      dateCreated: '2021-09-22',
      postedBy: 'Steve Witman',
