...
export class PostService {
  posts: PostDetail[] = [
    ...
    },
    {
      ...
      contentType: 'podcast',
      duration: '47',
      contentTitle: 'S1E14 | Making the Most of Tech Events and Conferences (The Angular Experience Podcast)',
      contentUrl:
    ...
    },
    {
      ...
      contentType: 'podcast',
      duration: '37',
      contentTitle: 'AMP11: Angular Community is Amazing with Grzegorz Lipke (Angular Master Podcast)',
    ...
    },
    {
      ...
      contentUrl: 'https://dev.to/ankittanna/what-s-new-in-typescript-4-4-ai7',
      contentDescription: 'TypeScript 4.4 came out with a lot of performance update plus some improved type checking. As a developer, you may be excited about a few of the features that are listed below.',
    ...
    },
    {
      ...
      contentType: 'podcast',
      duration: '54',
      contentTitle: 'Episode 18: Special Guest Tom! (ng build --pod Podcast)',
      contentUrl:
    ...
    },
    {
      ...
      contentUrl:
        'https://www.youtube.com/watch?v=-XB9BLkIJ8w',
      contentDescription:
        'John and Chris have a special guest on today. We are interviewing Tom. Tom is a developer at Miles Technologies and has been developing software using the Breckenridge template we\'ve been talking about so much. He helps share a 1st hand perspective of our software and share\'s his angular story.',
    ...
    },
    {
      ...
      contentType: 'blog',
      duration: '',
      contentTitle: 'The better side of the Single value Observables in RxJs',
      contentUrl:
    ...
    },
    {
      ...
      contentType: 'podcast',
      duration: '30',
      contentTitle: 'S1E16 | Change the World Highlight: Sondermind (The Angular Experience Podcast)',
      contentUrl:
    ...
    },
    {
      ...
      contentType: 'blog',
      duration: '',
      contentTitle: 'Inject dynamic content in Angular components with portals',
      contentUrl:
    ...
    },
    {
      ...
      contentType: 'podcast',
      duration: '36',
      contentTitle: "AMP13: Accelerating Angular Development with Ivy by Lars Gyrup Brink Nielsen (Angular Master Podcast)",
    ...
    },
    {
      ...
      contentUrl: 'https://delushaandelu.medium.com/angular-strict-mode-is-a-game-changer-72778ed94dcd',
      contentDescription:
    ...
    },
    {
      ...
      contentUrl: 'https://dev.to/walmyrlimaesilv/best-practices-in-test-automation-with-cypress-49ee',
      contentDescription: "",
    ...
    },
    {
      ...
      contentType: 'video',
      duration: '61',
      contentTitle: "Writing Cypress Tests Without Cucumber - Global Tester’s Day, 2021",
      contentUrl: 'https://www.youtube.com/watch?v=zcoAWehiZzg',
      contentDescription: "Are you a tester stuck using Cucumber and want to make use of the keywords Given/When/Then in cypress?",
    ...
    },
    {
      ...
      contentType: 'video',
      duration: '27',
      contentTitle: "Chat with Cecelia Martinez - Technical Account Manager at Cypress.io",
      contentUrl: 'https://www.youtube.com/watch?v=hXfTsdEXn0c',
      contentDescription: "In this chat, I had the pleasure of speaking with Cecelia, where she shared about her current and previous position at Cypress.io, how she helps Cypress customers, how Cypress uses its own products and lots of good practices.",
    ...
    },
    {
      ...
      contentDescription: "Brandon Roberts is joined by fellow Nrwlian and JavaScript Architect Ben Cabanes to discuss configuring and organizing your Nx workspace.",
    ...
    },
    {
      ...
      contentDescription: "Healthy debate about things like React versus Vue, OOP versus FP, strongly typed versus dynamically typed is fine, but sometimes it can get ugly. So let's talk about how to mitigate the fallout from a technical debate that gets too heated.",
    ...
    },
    {
      ...
      contentType: 'podcast',
      duration: '39',
      contentTitle: 'S1E17 | Finding Your Professional Path (The Angular Experience Podcast)',
      contentUrl:
    ...
    },
    {
      ...
      contentType: 'blog',
      duration: '',
      contentTitle: "TypeScript Features Every Angular Developer Needs to Know",
      contentUrl: 'https://dev.to/bitovi/typescript-features-every-angular-developer-needs-to-know-4b82',
      contentDescription: "If you\’re an Angular developer, you’re missing out if you’re not using advanced TypeScript features to help you build better code. And it’s well worth the effort: TypeScript has some great features that can make you a stronger Angular developer.",
    ...
    },
    {
      ...
      contentUrl: 'https://dev.to/this-is-angular/dry-way-to-manage-subscriptions-in-angular-components-256j',
      contentDescription: "This article explains how to manage subscriptions in Angular components without repeating the same teardown logic in each component. (Cover photo by Tim Swaan on Unsplash.)",
    ...
    },
    {
      ...
      contentUrl: 'https://indepth.dev/tutorials/angular/object-in-formcontrol',
      contentDescription: "Generally we use FormControl with either string or boolean types and hence it manages only simple values. But what if we want to manage just more than primitive data types? We can do that, let’s see how.",
    ...
    },
    {
      ...
      contentType: 'video',
      duration: '4',
      contentTitle: "How to integrate Google Pay in Angular - Payments DevBytes",
      contentUrl: 'https://www.youtube.com/watch?v=kRVBWHQDiAM',
      contentDescription: "The Google Pay Angular component makes integrating Google Pay into your Angular framework easier than ever. Follow along to a tutorial on how to integrate the Google Pay Angular component in Angular using npm. ",
    ...
    },
    {
      ...
      contentUrl: 'https://dev.to/saulodias/string-patterns-in-typescript-5b6k',
      contentDescription: "While we wait for a regex type in TypeScript, starting on TypeScript 4.1 we can make use of a very neat trick to create string patterns validations which can come in handy for some simple use cases.",
    ...
    },
    {
      ...
      contentType: 'video',
      duration: '134',
      contentTitle: "Angular Online Meetup, Sep. 2021 (Rainer Hahnekamp, Duncan Faulkner, Michael Zikes)",
      contentUrl: 'https://www.youtube.com/watch?v=ZXXDAJ-qIYU',
      contentDescription: "RxJS 7 - One Share to Rule them all (Deep Dive) - Rainer Hahnekamp | Angular Material - Form Field Fundamentals - Duncan Faulkner | Micro Frontend Routing – Solutions for mature Applications - Michael Zikes",
      ...
      likes: 0,
      featured: true,
      tags: ['RxJS 7', 'Micro Frontend Routing', 'Angular Material', 'Form Fields'],
    },
    {
      id: '29-a',
      slug: '2021-09-29-a',
    ...
    },
    {
      ...
      contentType: 'video',
      duration: '84',
      contentTitle: "Angular World Tour: Angular Athens - Deborah Kurata, Tracy Lee, and Emma Twersky",
    ...
    },
    {
      ...
      contentUrl: 'https://www.spreaker.com/user/ng-conf/e067-the-human-side-of-development',
      contentDescription:
    ...
    },
    {
      ...
      contentUrl: 'https://dev.to/mick_patterson_/how-to-use-environment-variables-in-an-angular-app-92g',
      contentDescription: "Environment variables in an Angular app are extremely useful for storing constants in your app that need to be used frequently, such as API url's, API access keys, Firebase config values and other general flags.",
    ...
    },
    {
      ...
      contentUrl: 'https://dev.to/_mnavarros/how-to-convert-html-to-pdf-using-angular-3jj8',
      contentDescription: "Yesterday, I was working on Hyperpanels' dashboard feature and my coworker @albertobeiz said the sentence every front-end developer fears: Can we generate a PDF from that?",
    ...
    },
    {
      ...
      contentType: 'video',
      duration: '28',
      contentTitle: "Build Reactive Table (Real world RxJS) | RxJS Tutorials",
      contentUrl: 'https://www.youtube.com/watch?v=GYLItMyFDIk',
      contentDescription: "This is the final video in a series. We apply the concepts covered so far in a relatively realistic scenario.",
